...
assert.ok(coverEditorSource.includes("COMPACT_EDITOR_SIZE_STORAGE_KEY = 'fasttag_cover_editor_size_compact_v2'"), 'compact Cover Editor dimensions should be remembered separately');
