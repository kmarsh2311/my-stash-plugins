...
### Fixed
- **Cover Editor Scene Navigation**: Moving to another scene closes the Cover Editor cleanly, restores the normal preview dimensions for the incoming scene, and stops navigation when an unsaved-cover discard warning is cancelled.
