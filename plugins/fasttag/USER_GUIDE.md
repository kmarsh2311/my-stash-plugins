...
FastTag adds rapid scene-card metadata editing to Stash. This guide covers version 4.4.4 and is also available as a searchable offline guide from FastTag Settings.
