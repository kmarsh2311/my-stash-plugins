(function initializeFastTagHelp(root) {
    ...
    const GUIDE_SECTIONS = Object.freeze([
        ...
        { id: 'video', icon: '🎬', title: 'Video, Scrubbing and Pop-out', html: `
            ...
            <p>Alternatively, choose a JPEG/PNG/WebP upload or clipboard image, review the proposed cover, and select Set Cover; cancelling makes no change. If the browser cannot play or capture the full-video format, the video controls are disabled with an explanation while upload and clipboard remain available. Direct clipboard access may require browser permission; Ctrl+V or Cmd+V remains the fallback.</p>
        ` },
