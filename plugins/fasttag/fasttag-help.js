(function initializeFastTagHelp(root) {
    ...
    const GUIDE_SECTIONS = Object.freeze([
        ...
        { id: 'video', icon: '🎬', title: 'Video, Scrubbing and Pop-out', html: `
            ...
            <h3>Cover Editor</h3><p>Select the picture button in Edit Everything's video controls to open the Cover Editor. The existing player moves into the cover workspace and switches to Full Video where possible. Persistent Play/Pause and step controls make precise selection easier, and Capture Frame pauses automatically before capturing. When the cover editor closes, the player returns to its previous embedded or floating location and restores its previous mode.</p>
