(function initializeFastTagHelp(root) {
    ...
    const GUIDE_SECTIONS = Object.freeze([
        ...
        { id: 'video', icon: '🎬', title: 'Video, Scrubbing and Pop-out', html: `
            ...
            <h3>Cover Editor</h3><p>Select the picture button in Edit Everything's video controls to open the separate Cover Editor HUD. It shows the current Stash cover and switches to Full Video where possible. Seek to a frame and select Capture Frame, or choose a JPEG/PNG/WebP upload or clipboard image. Review the proposed cover and select Set Cover; cancelling makes no change.</p>
            <p>If the browser cannot play or capture the full-video format, frame capture is disabled with an explanation while upload and clipboard remain available. Direct clipboard access may require browser permission; Ctrl+V or Cmd+V remains the fallback.</p>
        ` },
