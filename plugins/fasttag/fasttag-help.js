(function initializeFastTagHelp(root) {
    ...
    const GUIDE_SECTIONS = Object.freeze([
        ...
        { id: 'video', icon: '🎬', title: 'Video, Scrubbing and Pop-out', html: `
            ...
            <p>Alternatively, choose a JPEG/PNG/WebP upload or clipboard image, review the proposed cover, and select Set Cover; cancelling makes no change. On localhost or HTTPS, Paste can normally read the clipboard directly after browser permission. On an HTTP LAN address, select Paste and then press Ctrl+V or Cmd+V when prompted. This works with any LAN IP or hostname. If the browser cannot play or capture the full-video format, the video controls are disabled with an explanation while upload and clipboard remain available.</p>
        ` },
