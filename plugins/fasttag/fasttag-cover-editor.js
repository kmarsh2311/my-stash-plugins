(function initializeFastTagCoverEditor(root) {
    ...
    function openEditor(options) {
        ...
        body.innerHTML = `
            ...
            <div class="fasttag-cover-status" role="status" style="font-size:10.5px;line-height:1.35;min-height:43px;box-sizing:border-box;display:flex;align-items:center;padding:7px 8px;border-radius:6px;background:${isDark ? 'rgba(30,41,59,.8)' : '#e2e8f0'};color:${isDark ? '#cbd5e1' : '#334155'};">Opening the full video for frame capture…</div>
